...
proton#main#start
        clrf 0,0
        movlb 0
F2_SOF equ $ ; TRANSPONDER_MASTER.PRP
F2_EOF equ $ ; TRANSPONDER_MASTER.PRP
F1_SOF equ $ ; TRANSPONDER_MASTER.BAS
F1_000051 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRANSPONDER_MODE = UZAY
        clrf TRANSPONDER_MODE,0
F1_000057 equ $ ; IN [TRANSPONDER_MASTER.BAS] TR_MD = TR_OFF
        movlw 2
        movwf TR_MD,0
F1_000060 equ $ ; IN [TRANSPONDER_MASTER.BAS] ALL_DIGITAL   = TRUE
        clrf CM1CON0,0
        clrf CM2CON0,0
        clrf CM1CON,0
        clrf CM2CON,0
...
ram_bank = 15
        ...
        clrf ANSELB,1
        clrf ANSELC,1
F1_000071 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISA.0 = 1
        bsf TRISA,0,0
F1_000072 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISA.1 = 1
        bsf TRISA,1,0
F1_000073 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISA.2 = 1
        bsf TRISA,2,0
F1_000074 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISA.3 = 1
        bsf TRISA,3,0
F1_000075 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISA.4 = 0
        bcf TRISA,4,0
F1_000076 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISA.5 = 0
        bcf TRISA,5,0
F1_000078 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.0 = 1
        bsf TRISB,0,0
F1_000079 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.1 = 1
        bsf TRISB,1,0
F1_000080 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.2 = 1
        bsf TRISB,2,0
F1_000081 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.3 = 0
        bcf TRISB,3,0
F1_000082 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.4 = 0
        bcf TRISB,4,0
F1_000083 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.5 = 0
        bcf TRISB,5,0
F1_000084 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.6 = 0
        bcf TRISB,6,0
F1_000085 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISB.7 = 0
        bcf TRISB,7,0
F1_000087 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.0 = 0
        bcf TRISC,0,0
F1_000088 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.1 = 0
        bcf TRISC,1,0
F1_000089 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.2 = 0
        bcf TRISC,2,0
F1_000090 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.3 = 1
        bsf TRISC,3,0
F1_000091 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.4 = 1
        bsf TRISC,4,0
F1_000092 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.5 = 1
        bsf TRISC,5,0
F1_000093 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.6 = 1
        bsf TRISC,6,0
F1_000094 equ $ ; IN [TRANSPONDER_MASTER.BAS] TRISC.7 = 0
        bcf TRISC,7,0
F1_000133 equ $ ; IN [TRANSPONDER_MASTER.BAS] SANIYEBEKLE = 15
        movwf SaniyeBekle,0
F1_000137 equ $ ; IN [TRANSPONDER_MASTER.BAS] PWM_VAL= 5
        movlw 5
        movwf Pwm_val,0
F1_000182 equ $ ; IN [TRANSPONDER_MASTER.BAS] SEN = 1
        bsf SSP1CON2,0,0
F1_000191 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 500
        movlw 1
        movwf PP1H,0
        movlw 244
        f@call __DELAY_MS_W_
F1_000193 equ $ ; IN [TRANSPONDER_MASTER.BAS] TMR1_ENABLE = 0
        bcf PIE1,0,0
F1_000195 equ $ ; IN [TRANSPONDER_MASTER.BAS] PEIE = 1
        bsf INTCON,6,0
F1_000196 equ $ ; IN [TRANSPONDER_MASTER.BAS] T1CON.1 = 0
        bcf T1CON,1,0
F1_000197 equ $ ; IN [TRANSPONDER_MASTER.BAS] T1CON.4 = 0
        bcf T1CON,4,0
F1_000199 equ $ ; IN [TRANSPONDER_MASTER.BAS] TMR1_ENABLE = 1
        bsf PIE1,0,0
F1_000200 equ $ ; IN [TRANSPONDER_MASTER.BAS] TMR1_ON = 1
        bsf T1CON,0,0
F1_000202 equ $ ; IN [TRANSPONDER_MASTER.BAS] GIE = 1
        bsf INTCON,7,0
F1_000208 equ $ ; IN [TRANSPONDER_MASTER.BAS] DURUM = 0
        clrf DURUM,0
F1_000212 equ $ ; IN [TRANSPONDER_MASTER.BAS] PLLYAZ_LATCH = 1
        bsf _B#VR1,0,0
F1_000215 equ $ ; IN [TRANSPONDER_MASTER.BAS] DUTYCYCLE = 0
        clrf DutyCycle,0
F1_000218 equ $ ; IN [TRANSPONDER_MASTER.BAS] HPWM 1,PWM_VAL,2000
        movff Pwm_val,GEN
        movlw 7
        movwf PP1H,0
        movlw 208
        ...
        movlw 1
        f@call __HPWM_
F1_000220 equ $ ; IN [TRANSPONDER_MASTER.BAS] GOTO PREMAIN
        movlb 0
ram_bank = 0
        f@jump PreMain
InterruptSection
F1_000225 equ $ ; IN [TRANSPONDER_MASTER.BAS] CONTEXT SAVE
        movlb 0
        movff SP#P9,_High__Context_Store#0
F1_000227 equ $ ; IN [TRANSPONDER_MASTER.BAS] GIE = 0
        bcf INTCON,7,0
F1_000229 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF TMR1_OVERFLOW = 1 AND TMR1_ENABLE = 1 THEN
        movlw 0
        btfsc PIR1,0,0
        movlw 1
        movwf SP#P9,0
        ...
        btfsc STATUS,2,0
        go@to BC@LL3
F1_000230 equ $ ; IN [TRANSPONDER_MASTER.BAS] TMR1_ENABLE = 0
        bcf PIE1,0,0
F1_000231 equ $ ; IN [TRANSPONDER_MASTER.BAS] TIMER1 = TIMER1 + TMR1_VAL
        movlw 24
        addwf TMR1L,F,0
        movlw 252
        addwfc TMR1LH,F,0
F1_000232 equ $ ; IN [TRANSPONDER_MASTER.BAS] TMR1_ENABLE = 1
        bsf PIE1,0,0
F1_000233 equ $ ; IN [TRANSPONDER_MASTER.BAS] TMR1_OVERFLOW = 0
        bcf PIR1,0,0
F1_000234 equ $ ; IN [TRANSPONDER_MASTER.BAS] MS = MS + TMR1_MS
        infsnz mS,F,0
        incf mSH,F,0
F1_000235 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF MS >= 1000 THEN
        movlw 232
        subwf mS,W,0
        movlw 3
        subwfb mSH,W,0
        btfss STATUS,0,0
        go@to BC@LL5
F1_000237 equ $ ; IN [TRANSPONDER_MASTER.BAS] MS = 0
        clrf mSH,0
        clrf mS,0
F1_000238 equ $ ; IN [TRANSPONDER_MASTER.BAS] S = S + 1
        infsnz _S,F,0
        incf _SH,F,0
F1_000239 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF S >= 59 THEN
        movf _SH,F,0
        btfss STATUS,2,0
        bra CP@LB3
        movlw 58
        ...
        f@jump BC@LL7
CP@LB3
F1_000240 equ $ ; IN [TRANSPONDER_MASTER.BAS] S = 0
        clrf _SH,0
        clrf _S,0
F1_000241 equ $ ; IN [TRANSPONDER_MASTER.BAS] MN = MN + 1
        incf mn,F,0
F1_000242 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF MN >= 59 THEN
        movlw 58
        cpfsgt mn,0
        f@jump BC@LL9
F1_000243 equ $ ; IN [TRANSPONDER_MASTER.BAS] MN = 0
        clrf mn,0
F1_000244 equ $ ; IN [TRANSPONDER_MASTER.BAS] HR = HR + 1
        incf hr,F,0
F1_000245 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF HR >= 24 THEN
        movlw 23
        cpfsgt hr,0
        f@jump BC@LL11
F1_000246 equ $ ; IN [TRANSPONDER_MASTER.BAS] HR = 0
        clrf hr,0
F1_000247 equ $ ; IN [TRANSPONDER_MASTER.BAS] DY = DY + 1
        incf dy,F,0
F1_000248 equ $ ; IN [TRANSPONDER_MASTER.BAS] ENDIF
BC@LL11
F1_000249 equ $ ; IN [TRANSPONDER_MASTER.BAS] ENDIF
BC@LL9
F1_000250 equ $ ; IN [TRANSPONDER_MASTER.BAS] ENDIF
BC@LL7
F1_000251 equ $ ; IN [TRANSPONDER_MASTER.BAS] ENDIF
BC@LL5
F1_000252 equ $ ; IN [TRANSPONDER_MASTER.BAS] ENDIF
BC@LL3
F1_000254 equ $ ; IN [TRANSPONDER_MASTER.BAS] GIE = 1
        bsf INTCON,7,0
F1_000256 equ $ ; IN [TRANSPONDER_MASTER.BAS] CONTEXT RESTORE
        movff _High__Context_Store#0,SP#P9
        retfie 1
PreMain
F1_000260 equ $ ; IN [TRANSPONDER_MASTER.BAS] S = 0
        clrf _SH,0
        clrf _S,0
F1_000261 equ $ ; IN [TRANSPONDER_MASTER.BAS] MN = 0
        clrf mn,0
F1_000262 equ $ ; IN [TRANSPONDER_MASTER.BAS] HR   = 0
        clrf hr,0
F1_000263 equ $ ; IN [TRANSPONDER_MASTER.BAS] DY    = 0
        clrf dy,0
F1_000266 equ $ ; IN [TRANSPONDER_MASTER.BAS] LOW PLLPSRF
        bcf TRISB,6,0
        bcf LATB,6,0
F1_000267 equ $ ; IN [TRANSPONDER_MASTER.BAS] LOW PLLPSIF
        bcf TRISB,7,0
        bcf LATB,7,0
F1_000268 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 10
        movlw 10
        f@call __DELAY_MS_
F1_000269 equ $ ; IN [TRANSPONDER_MASTER.BAS] LOW PLLLE
        bcf TRISB,5,0
        bcf LATB,5,0
F1_000270 equ $ ; IN [TRANSPONDER_MASTER.BAS] HIGH PLLPSRF
        bcf TRISB,6,0
        bsf LATB,6,0
F1_000271 equ $ ; IN [TRANSPONDER_MASTER.BAS] HIGH PLLPSIF
        bcf TRISB,7,0
        bsf LATB,7,0
F1_000276 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF TRANSPONDER_MODE = LAB THEN
        decfsz TRANSPONDER_MODE,W,0
        f@jump BC@LL13
F1_000277 equ $ ; IN [TRANSPONDER_MASTER.BAS] LOW  TPS2421EN
        bcf TRISA,4,0
        bcf LATA,4,0
F1_000278 equ $ ; IN [TRANSPONDER_MASTER.BAS] HIGH LD29300ENABLE
        bcf TRISC,0,0
        bsf LATC,0,0
F1_000279 equ $ ; IN [TRANSPONDER_MASTER.BAS] TR_MD = TR_ON
        movlw 1
        movwf TR_MD,0
F1_000280 equ $ ; IN [TRANSPONDER_MASTER.BAS] ENDIF
BC@LL13
F1_000282 equ $ ; IN [TRANSPONDER_MASTER.BAS] GOSUB PLL_PROGRAMLA
        f@call Pll_Programla
F1_000294 equ $ ; IN [TRANSPONDER_MASTER.BAS] RESET_COUNT = EREAD 0
        movlw 0
        f@call __EEREAD_
        movwf Reset_Count,0
        f@call __EEREAD_W_
        movwf Reset_CountH,0
F1_000295 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF RESET_COUNT = 0 THEN GOSUB ANTENLERI_AC
        ...
        f@call Antenleri_ac
BC@LL15
F1_000296 equ $ ; IN [TRANSPONDER_MASTER.BAS] EWRITE 0,[RESET_COUNT + 1]
        clrf EEADR,0
        movlw 1
        ...
        f@call __EEWRITE_
Main
F1_000308 equ $ ; IN [TRANSPONDER_MASTER.BAS] DONGUSAY = DONGUSAY + 1
        incf dongusay,F,1
F1_000311 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 10
        movlw 10
        f@call __DELAY_MS_
F1_000315 equ $ ; IN [TRANSPONDER_MASTER.BAS] I2COUT PORTC.4, PORTC.3, $56,[1]
        movlw PORTC
        movwf GEN,0
        movlw 16
        movwf GENH,0
        ...
        movlw 1
        f@call I2COUT2
F1_000316 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 5
        movlw 5
        f@call __DELAY_MS_
F1_000317 equ $ ; IN [TRANSPONDER_MASTER.BAS] I2CIN PORTC.4, PORTC.3, $56,[EPSSTATUS]
        movlw PORTC
        movwf GEN,0
        movlw 16
        movwf GENH,0
        ...
        f@call I2CIN2
        movwf EPSstatus,1
F1_000318 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 5
        movlw 5
        f@call __DELAY_MS_
F1_000320 equ $ ; IN [TRANSPONDER_MASTER.BAS] I2COUT PORTC.4, PORTC.3, $56, 0,[3]
        movlw PORTC
        movwf GEN,0
        movlw 16
        movwf GENH,0
        ...
        movlw 3
        f@call I2COUT2
F1_000321 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 10
        movlw 10
        f@call __DELAY_MS_
F1_000322 equ $ ; IN [TRANSPONDER_MASTER.BAS] I2CIN PORTC.4, PORTC.3, $56,[EPS_ADCVAL[3]]
        movlw PORTC
        movwf GEN,0
        movlw 16
        movwf GENH,0
        ...
        f@call I2CIN2
        movwf PBP#VAR0,0
        movff PBP#VAR0H,EPS_ADCVal#3H
        movff PBP#VAR0,EPS_ADCVal#3
F1_000323 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 1
        movlw 1
        f@call __DELAY_MS_
F1_000351 equ $ ; IN [TRANSPONDER_MASTER.BAS] TPS_AKIM = ADIN 1
        movlw 1
        f@call __ADIN_
        movwf TPS_Akim,0
        movff PP7H,TPS_AkimH
F1_000352 equ $ ; IN [TRANSPONDER_MASTER.BAS] TPS_AKIM = TPS_AKIM >> 2
        bcf STATUS,0,0
        rrcf TPS_AkimH,F,0
        rrcf TPS_Akim,F,0
        bcf STATUS,0,0
        rrcf TPS_AkimH,F,0
        rrcf TPS_Akim,F,0
F1_000353 equ $ ; IN [TRANSPONDER_MASTER.BAS] CIKIS_GUCU = ADIN 2
        movlw 2
        f@call __ADIN_
        movwf Cikis_Gucu,0
        movff PP7H,Cikis_GucuH
F1_000354 equ $ ; IN [TRANSPONDER_MASTER.BAS] CIKIS_GUCU = CIKIS_GUCU >> 2
        bcf STATUS,0,0
        ...
        rrcf Cikis_GucuH,F,0
        rrcf Cikis_Gucu,F,0
F1_000435 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 10
        movlw 10
        f@call __DELAY_MS_
F1_000441 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 1000
        movlw 3
        movwf PP1H,0
        movlw 232
        f@call __DELAY_MS_W_
F1_000445 equ $ ; IN [TRANSPONDER_MASTER.BAS] GOTO MAIN
        f@jump Main
Antenleri_ac
F1_000451 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYMS 1000
        movlw 3
        movwf PP1H,0
        movlw 232
        f@call __DELAY_MS_W_
F1_000453 equ $ ; IN [TRANSPONDER_MASTER.BAS] RETURN
        return 0
Pll_Programla
F1_000457 equ $ ; IN [TRANSPONDER_MASTER.BAS] DATAOUT =  %000000000000000100110000010000
        clrf DataOutHHH,0
        clrf DataOutHH,0
        movlw 76
        movwf DataOutH,0
        movlw 16
        movwf DataOut,0
F1_000458 equ $ ; IN [TRANSPONDER_MASTER.BAS] GOSUB PLLGONDER
        f@call Pllgonder
F1_000459 equ $ ; IN [TRANSPONDER_MASTER.BAS] DATAOUT =  %000000001101100000011110101101
        clrf DataOutHHH,0
        movlw 54
        movwf DataOutHH,0
        movlw 7
        ...
        movlw 173
        movwf DataOut,0
F1_000460 equ $ ; IN [TRANSPONDER_MASTER.BAS] GOSUB     PLLGONDER
        f@call Pllgonder
F1_000461 equ $ ; IN [TRANSPONDER_MASTER.BAS] DATAOUT =  %000000010000000010100000010000
        clrf DataOutHHH,0
        movlw 64
        movwf DataOutHH,0
        movlw 40
        ...
        movlw 16
        movwf DataOut,0
F1_000462 equ $ ; IN [TRANSPONDER_MASTER.BAS] GOSUB PLLGONDER
        f@call Pllgonder
F1_000463 equ $ ; IN [TRANSPONDER_MASTER.BAS] DATAOUT =  %000000011011111101010011011000
        clrf DataOutHHH,0
        movlw 111
        movwf DataOutHH,0
        movlw 212
        ...
        movlw 216
        movwf DataOut,0
F1_000464 equ $ ; IN [TRANSPONDER_MASTER.BAS] GOSUB     PLLGONDER
        f@call Pllgonder
F1_000465 equ $ ; IN [TRANSPONDER_MASTER.BAS] RETURN
        return 0
Pllgonder
F1_000469 equ $ ; IN [TRANSPONDER_MASTER.BAS] FOR SAYAC = 1 TO 23
        movlw 1
        movwf sayac,0
FR@LB16
        movlw 24
        cpfslt sayac,0
        f@jump NX@LB17
F1_000470 equ $ ; IN [TRANSPONDER_MASTER.BAS] LOW PLLDATA
        bcf TRISB,4,0
        bcf LATB,4,0
F1_000471 equ $ ; IN [TRANSPONDER_MASTER.BAS] IF (DATAOUT & 1) = 1 THEN HIGH PLLDATA
        movlw 1
        andwf DataOut,W,0
        clrf PBP#VAR0HHH,0
        clrf PBP#VAR0HH,0
        ...
        bsf LATB,4,0
BC@LL20
F1_000472 equ $ ; IN [TRANSPONDER_MASTER.BAS] DATAOUT = DATAOUT >> 1
        bcf STATUS,0,0
        rrcf DataOutHHH,F,0
        rrcf DataOutHH,F,0
        rrcf DataOutH,F,0
        rrcf DataOut,F,0
F1_000473 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000474 equ $ ; IN [TRANSPONDER_MASTER.BAS] HIGH PLLCLK
        bcf TRISB,3,0
        bsf LATB,3,0
F1_000475 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000476 equ $ ; IN [TRANSPONDER_MASTER.BAS] LOW PLLCLK
        bcf TRISB,3,0
        bcf LATB,3,0
F1_000477 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
CT@LB18
F1_000478 equ $ ; IN [TRANSPONDER_MASTER.BAS] NEXT SAYAC
        incf sayac,F,0
        btfss STATUS,0,0
        go@to FR@LB16
NX@LB17
F1_000480 equ $ ; IN [TRANSPONDER_MASTER.BAS] HIGH PLLLE
        bcf TRISB,5,0
        bsf LATB,5,0
F1_000481 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000482 equ $ ; IN [TRANSPONDER_MASTER.BAS] LOW PLLLE
        bcf TRISB,5,0
        bcf LATB,5,0
F1_000483 equ $ ; IN [TRANSPONDER_MASTER.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000485 equ $ ; IN [TRANSPONDER_MASTER.BAS] RETURN
        return 0
F1_EOF equ $ ; TRANSPONDER_MASTER.BAS
PB@LB21
        bra PB@LB21
__EOF
config FOSC = XT
